  ...
  return (
    <div>
      <div id="Home" className="w-screen max-w-full">
        <Nav />
        <div className="w-screen shadow-xl flex items-center h-[440px] bg-home bg-no-repeat bg-cover max-w-full text-7xl text-white font-medium  "><p data-aos="fade-right" className="w-3/4 ml-10">Bem vindo a <strong className="font-extrabold">Nunes pizzaria</strong>, venha apreciar uma boa pizza.</p> </div>
        <div data-aos="fade-up" className="flex w-full gap-10 justify-between px-36 mt-32 max-w-full pb-20 text-2xl font-bold text-white" >
          <p className=" w-1/3 h-72 bg-pizza bg-cover bg-no-repeat rounded flex items-end justify-center shadow-xl">Pizzas</p>
          <p className=" w-1/3 h-72  bg-carne bg-no-repeat rounded flex items-end justify-center shadow-xl">Carnes</p>
          <p className=" w-1/3 h-72 bg-sushi bg-cover bg-no-repeat rounded flex items-end justify-center shadow-xl">Sushis</p>
        </div>
      </div>

      <div id="About" className="h-screen w-screen max-w-full">
        <div data-aos="fade-right" className="w-full h-44 mt-28 shadow-xl bg-[#bf4949] px-10 pt-5">
          <h2 className="text-white font-bold text-5xl">Sobre nós:</h2>
          <p className="text-2xl font-semibold text-white mt-5">Surgimos em 2019, com objetivo de conquistar o público limoeirense com a maior qualidade e bom gosto possível.</p>
        </div>
        <Swiper
          slidesPerView={1}
          spaceBetween={10}
          ...
          className="w-[60%] h-60 flex flex-col mt-20 shadow-xl rounded-md text-black justify-center absolute items-center"
        >
          <SwiperSlide className="w-72 py-12 shadow-xl">
      ...
      <div data-aos="fade-up" id="Contact" className=" flex gap-20 w-full h-[20%] px-10 bg-[#831313]">
        <div>
